...
public class StrabonBeanWrapper implements org.springframework.beans.factory.DisposableBean {
    ...
    private static Logger logger = LoggerFactory.getLogger(eu.earthobservatory.org.StrabonLivyEndpoint.StrabonBeanWrapper.class);
...
//                }
     ...
     */
    private static void installSIGTERMHandler(final StrabonLivyRepo strabon) {
    ...
    public StrabonLivyRepo getStrabon() {
        return strabon;
    }

    public void setStrabon(StrabonLivyRepo strabon) {
    ...
    public void describe(String queryString, String answerFormatStrabon, OutputStream out)
        ...
        //TODO strabon.describe(queryString, answerFormatStrabon, strabon.getSailRepoConnection(), out);
    }
    ...
    public Object update(String updateString, String answerFormatStrabon)
        ...
        //TODO strabon.update(updateString, strabon.getSailRepoConnection());
        return "OK!";
    }
     ...
     * @throws ClassNotFoundException
     */
    public boolean store(String src, String context, String format, Boolean inference, Boolean url) throws RepositoryException, RDFParseException, RDFHandlerException, IOException {
        ...
        //TODO strabon.storeInRepo(src, null, context, format, inference);
