...
<jsp:directive.page import="eu.earthobservatory.org.StrabonLivyEndpoint.Common"/>
...
<TABLE class="style4">	
	...
	<TR>
                <TD valign="top" class="style4">File Path for Statistiscs:</TD>
                <TD><input type="text" name="statisticsfile" value="<%=request.getAttribute("statisticsfile")%>"/></TD>
        </TR>
	<TR>
                <TD valign="top" class="style4">File Path for Dictionary:</TD>
                <TD><input type="text" name="dictionaryfile" value="<%=request.getAttribute("dictionaryfile")%>"/></TD>
        </TR>
	<TR>
                <TD valign="top" class="style4">asWKT Tables File:</TD>
                <TD><input type="text" name="asWKTfile" value="<%=request.getAttribute("asWKTfile")%>"/></TD>
        </TR>
	 <TR>
