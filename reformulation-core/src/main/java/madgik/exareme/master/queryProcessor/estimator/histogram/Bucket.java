...
public final class Bucket {
	...
	public static final Bucket FINAL_HISTOGRAM_BUCKET = new Bucket(EMPTY_BUCKET_FREQ, EMPTY_BUCKET_DIFF_VAL);
	...
	public static final Bucket TRANSPARENT_BUCKET = new Bucket(TRANSPARENT_FREQ, MIN_BUCKET_WIDTH);
	...
	public int hashCode() {
		int hash = 3;
		hash = 23 * hash
				+ (int) (Double.doubleToLongBits(this.frequency) ^ (Double.doubleToLongBits(this.frequency) >>> 32));
		hash = 23 * hash
