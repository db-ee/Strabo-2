...
public class StatUtils {
	...
	public static boolean isCompatibleType(int columnType) {
		if (columnType == Types.BOOLEAN || columnType == Types.CHAR || columnType == Types.DATE
				|| columnType == Types.DECIMAL || columnType == Types.DOUBLE || columnType == Types.FLOAT
				|| columnType == Types.INTEGER || columnType == Types.NUMERIC || columnType == Types.TIME
				|| columnType == Types.TIMESTAMP || columnType == Types.TINYINT || columnType == Types.VARCHAR)
			return true;
		else
			return false;
